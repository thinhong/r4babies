...
{{< downloadthis data/gdp-capita.xlsx dname="gdp-capita" label="Download xlsx" type=light >}} {{< downloadthis data/life-exp.csv dname="life-exp" label="Download csv" type=light >}}
