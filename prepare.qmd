...
{{< downloadthis data/gdp-capita.xlsx dname="gdp-capita" label="gdp-capita.xlsx" type=light >}} {{< downloadthis data/life-exp.csv dname="life-exp" label="life-exp.csv" type=light >}} {{< downloadthis data/linelist_raw.dta dname="linelist_raw" label="linelist_raw.dta" type=light >}}
...
```{r}
library(haven)
df <- read_dta(file = "data/linelist_raw.dta")
head(df)
```
