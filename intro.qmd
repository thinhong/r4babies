...
::: center-text
[{{< fa link >}} Presentation](https://drthinhong.com/r4babies-slides/intro.html){.btn .btn-outline-secondary role="button"}
:::

::: callout-note
# Trước buổi học

-   Cài đặt R và RStudio (xem @sec-install)
...
![](img/intro/rstudio_components.png)Vì vậy, chúng ta cần cài đặt riêng R (ngôn ngữ lập trình) và RStudio (IDE).
...
Lepton là phần mềm quản lý snippet sử dụng tài khoản GitHub. Vào [**link này**](https://github.com/hackjutsu/Lepton) và kéo xuống phần Installation để cài đặt Lepton theo hướng dẫn.

![](img/intro/lepton-install.png)

### Github gist

Để sử dụng Lepton cần tạo tài khoản Github. Vào [**link này**](https://github.com/) nhấn **Sign up** ở góc trên cùng bên phải màn hình và tạo tài khoản Github.

![](img/intro/github-signup.png)

### Sử dụng Lepton

Đăng nhập Lepton bằng tài khoản Github.

![](img/intro/lepton-login.png)

Giao diện Lepton.

![](img/intro/lepton-interface.png)

Bấm `New` ở góc trái để tạo snippet mới.

![](img/intro/lepton-new.png)

Khi cần tìm snippet, nhấn `Shift` + `Space`.

![](img/intro/lepton-search.png)

![](img/intro/lepton-search-results.png)
...
-   Văn bản: phần diễn giải cho tài liệu, gồm các đề mục và chữ diễn giải viết theo ngôn ngữ [markdown](https://rmarkdown.rstudio.com/lesson-8.html).
