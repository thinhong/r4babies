...
| Function                  | Công dụng                                   |
+===========================+=============================================+
| `colorNumeric()`          | tạo pallete màu liên tục từ biến liên tục   |
+---------------------------+---------------------------------------------+
| `colorBin()`              | tạo pallete màu phân loại từ biến liên tục  |
+---------------------------+---------------------------------------------+
| `colorFactor()`           | tạo pallete màu phân loại từ biến phân loại |
+---------------------------+---------------------------------------------+
:::
