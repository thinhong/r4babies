...
- Không có ký tự đặc biệt (&, #, \<, \>, ...) hoặc dấu. - Không bắt đầu bằng số.
...
Cú pháp chung cho thay đổi datatype là `as.tên_định_dạng()`
...
`dmy()`, `ymd()`, `mdy()`, ... chuyển đổi text theo các format khác nhau thành định dạng ngày
